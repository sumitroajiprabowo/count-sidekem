...
for a in kecamatan:
    ...
    """air_kemasan_eceran"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' \
    ...
    """insert to sql"""
    cur.execute("UPDATE `statistik_sanitasi_kec` SET `air_kemasan_eceran`='"+air_kemasan_eceran+"', `air_isi_ulang_eceran`='"+air_isi_ulang_eceran+"', \
    ...
    """insert to sql"""
    cur.execute("UPDATE `statistik_sanitasi_kec` SET `air_kemasan_langganan`='"+air_kemasan_langganan+"', `air_isi_ulang_langganan`='"+air_isi_ulang_langganan+"', \
    ...
    """insert to sql"""
    cur.execute("UPDATE `statistik_sanitasi_kec` SET `air_kemasan_tdk_beli`='"+air_kemasan_tdk_beli+"', `air_isi_ulang_tdk_beli`='"+air_isi_ulang_tdk_beli+"', \
    ...
    """air_kemasan_total"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND sumber_air_minum LIKE '1' ")
    air_kemasan_total = str(cur.fetchone()[0])
    """air_isi_ulang_total"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND sumber_air_minum LIKE '2' ")
    air_isi_ulang_total = str(cur.fetchone()[0])
    """leding_meteran_total"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND sumber_air_minum LIKE '3' ")
    leding_meteran_total = str(cur.fetchone()[0])
    """leding_eceran_total"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND sumber_air_minum LIKE '4' ")
    leding_eceran_total = str(cur.fetchone()[0])
    """sumur_bor_pompa_total"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND sumber_air_minum LIKE '5' ")
    sumur_bor_pompa_total = str(cur.fetchone()[0])
    """sumur_terlindung_total"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND sumber_air_minum LIKE '6' ")
    sumur_terlindung_total = str(cur.fetchone()[0])
    """sumur_tak_terlindung_total"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND sumber_air_minum LIKE '7' ")
    sumur_tak_terlindung_total = str(cur.fetchone()[0])
    """mata_air_terlindung_total"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND sumber_air_minum LIKE '8' ")
    mata_air_terlindung_total = str(cur.fetchone()[0])
    """mata_air_tak_terlindung_total"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND sumber_air_minum LIKE '9' ")
    mata_air_tak_terlindung_total = str(cur.fetchone()[0])
    """air_sungai_danau_waduk_total"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND sumber_air_minum LIKE '10' ")
    air_sungai_danau_waduk_total = str(cur.fetchone()[0])
    """air_hujan_total"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND sumber_air_minum LIKE '11' ")
    air_hujan_total = str(cur.fetchone()[0])
    """lainnya_total"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND sumber_air_minum LIKE '12' ")
    lainnya_total = str(cur.fetchone()[0])
    """insert to sql"""
    cur.execute("UPDATE `statistik_sanitasi_kec` SET `air_kemasan_total`='"+air_kemasan_total+"', `air_isi_ulang_total`='"+air_isi_ulang_total+"', \
    ...
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND fasilitas_bab LIKE '1' ")
    fasilitas_bab_sendiri = str(cur.fetchone()[0])
    """fasilitas_bab_umum"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND fasilitas_bab LIKE '2' ")
    fasilitas_bab_umum = str(cur.fetchone()[0])
    """fasilitas_bab_bersama"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND fasilitas_bab LIKE '3' ")
    fasilitas_bab_bersama = str(cur.fetchone()[0])
    """fasilitas_bab_tdk_ada"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND fasilitas_bab LIKE '4' ")
    fasilitas_bab_tdk_ada = str(cur.fetchone()[0])
    """insert to sql"""
    cur.execute("UPDATE `statistik_sanitasi_kec` SET `fasilitas_bab_sendiri`='"+fasilitas_bab_sendiri+"', \
    ...
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND jenis_kloset LIKE '1' ")
    jenis_kloset_leher_angsa = str(cur.fetchone()[0])
    """jenis_kloset_plengsengan"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND jenis_kloset LIKE '2' ")
    jenis_kloset_plengsengan = str(cur.fetchone()[0])
    """jenis_kloset_cemplung/cubluk"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND jenis_kloset LIKE '3' ")
    jenis_kloset_cemplungcubluk = str(cur.fetchone()[0])
    """jenis_kloset_tdk_pakai"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND jenis_kloset LIKE '4' ")
    jenis_kloset_tdk_pakai = str(cur.fetchone()[0])
    """insert to sql"""
    cur.execute("UPDATE `statistik_sanitasi_kec` SET `jenis_kloset_leher_angsa`='"+jenis_kloset_leher_angsa+"', \
    ...
    """Counting TPA"""
    """pembuangan_tangki"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND tpa_tinja LIKE '1' ")
    pembuangan_tangki = str(cur.fetchone()[0])
    """pembuangan_spal"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND tpa_tinja LIKE '2' ")
    pembuangan_spal = str(cur.fetchone()[0])
    """pembuangan_lubang_tanah"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND tpa_tinja LIKE '3' ")
    pembuangan_lubang_tanah = str(cur.fetchone()[0])
    """pembuangan_kolamsawahsungaidanaulaut"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND tpa_tinja LIKE '4' ")
    pembuangan_kolamsawahsungaidanaulaut = str(cur.fetchone()[0])
    """pembuangan_pantai_tanahlapang_kebun"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND tpa_tinja LIKE '5' ")
    pembuangan_pantai_tanahlapang_kebun = str(cur.fetchone()[0])
    """pembuangan_lainnya"""
    cur.execute("SELECT COUNT(*) FROM `bdt_kemiskinan-33`  WHERE kec_id='"+a[0]+"' AND tpa_tinja LIKE '6' ")
    pembuangan_lainnya = str(cur.fetchone()[0])
    """insert to sql"""
    cur.execute("UPDATE `statistik_sanitasi_kec` SET `pembuangan_tangki`='"+pembuangan_tangki+"', `pembuangan_spal`='"+pembuangan_spal+"', `pembuangan_lubang_tanah`='"+pembuangan_lubang_tanah+"', \
