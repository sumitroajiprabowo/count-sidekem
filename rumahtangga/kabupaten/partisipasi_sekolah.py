...
for a in kabupaten:
    ...
    cur.execute("SELECT COUNT(*) FROM `bdt_rumahtangga-33`  WHERE kab_id='"+a[0]+"' \
    ...
    """Insert to DB"""
    cur.execute("UPDATE `statistik_partisipasi_sekolah_kab` SET `5th_keatas_tdk_blm_pernah_sekolah`='"+lima_th_keatas_tdk_blm_pernah_sekolah+"', \
    ...
    """Insert to DB"""
    cur.execute("UPDATE `statistik_partisipasi_sekolah_kab` SET `5_20th_tdk_blm_pernah_sekolah`='"+lima_duapuluh_th_tdk_blm_pernah_sekolah+"', \
    ...
    cur.execute("UPDATE `statistik_partisipasi_sekolah_kab` SET `masih_sekolah_sd`='"+masih_sekolah_sd+"', \
    ...
    cur.execute("SELECT COUNT(*) FROM `bdt_rumahtangga-33`  WHERE kab_id='"+a[0]+"' AND \
    ...
    """Insert to DB"""
    cur.execute("UPDATE `statistik_partisipasi_sekolah_kab` SET `msh_sekolah_kls_tertinggi_1`='"+msh_sekolah_kls_tertinggi_1+"', \
    ...
    """Insert to DB"""
    cur.execute("UPDATE `statistik_partisipasi_sekolah_kab` SET `msh_sekolah_tdk_punya_ijazah`='"+msh_sekolah_tdk_punya_ijazah+"', \
