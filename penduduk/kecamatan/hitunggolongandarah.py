...
cur = db.cursor()
cur.execute("SELECT id FROM `statistik_goldarah_kec` WHERE id LIKE '%3327%' ")
kecamatan=cur.fetchall()
for a in kecamatan:
    #Total Golongan Darah
    cur.execute("SELECT COUNT(*) FROM `datapenduduk-33` WHERE kec_id='"+a[0]+"' AND goldarah LIKE 'A' ")
    goldar1 = str(cur.fetchone()[0])
    cur.execute("SELECT COUNT(*) FROM `datapenduduk-33` WHERE kec_id='"+a[0]+"' AND goldarah LIKE 'B' ")
    goldar2 = str(cur.fetchone()[0])
    cur.execute("SELECT COUNT(*) FROM `datapenduduk-33` WHERE kec_id='"+a[0]+"' AND goldarah LIKE 'AB' ")
    goldar3 = str(cur.fetchone()[0])
    cur.execute("SELECT COUNT(*) FROM `datapenduduk-33` WHERE kec_id='"+a[0]+"' AND goldarah LIKE 'O' ")
    ...
    cur.execute("SELECT COUNT(*) FROM `datapenduduk-33` WHERE kec_id='"+a[0]+"' AND goldarah IN('-','','Tidak Tahu','Tdk Tahu') ")
    goldar13 = str(cur.fetchone()[0])
    #Laki-laki
    cur.execute("SELECT COUNT(*) FROM `datapenduduk-33` WHERE kec_id='"+a[0]+"' AND jk LIKE 'L%' AND goldarah LIKE 'A' ")
    goldar14 = str(cur.fetchone()[0])
    cur.execute("SELECT COUNT(*) FROM `datapenduduk-33` WHERE kec_id='"+a[0]+"' AND jk LIKE 'L%' AND goldarah LIKE 'B' ")
    goldar15 = str(cur.fetchone()[0])
    cur.execute("SELECT COUNT(*) FROM `datapenduduk-33` WHERE kec_id='"+a[0]+"' AND jk LIKE 'L%' AND goldarah LIKE 'AB' ")
    goldar16 = str(cur.fetchone()[0])
    cur.execute("SELECT COUNT(*) FROM `datapenduduk-33` WHERE kec_id='"+a[0]+"' AND jk LIKE 'L%' AND goldarah LIKE 'O' ")
    ...
    cur.execute("SELECT COUNT(*) FROM `datapenduduk-33` WHERE kec_id='"+a[0]+"' AND jk LIKE 'L%' AND goldarah IN('-','','Tidak Tahu','Tdk Tahu') ")
    goldar26 = str(cur.fetchone()[0])
    #Perempuan
    cur.execute("SELECT COUNT(*) FROM `datapenduduk-33` WHERE kec_id='"+a[0]+"' AND jk LIKE 'P%' AND goldarah LIKE 'A' ")
    goldar27 = str(cur.fetchone()[0])
    cur.execute("SELECT COUNT(*) FROM `datapenduduk-33` WHERE kec_id='"+a[0]+"' AND jk LIKE 'P%' AND goldarah LIKE 'B' ")
    goldar28 = str(cur.fetchone()[0])
    cur.execute("SELECT COUNT(*) FROM `datapenduduk-33` WHERE kec_id='"+a[0]+"' AND jk LIKE 'P%' AND goldarah LIKE 'AB' ")
    goldar29 = str(cur.fetchone()[0])
    cur.execute("SELECT COUNT(*) FROM `datapenduduk-33` WHERE kec_id='"+a[0]+"' AND jk LIKE 'P%' AND goldarah LIKE 'O' ")
